package Trimestre2.Boletin51.Ejercicio1.Examen.main;
...
import Trimestre2.Boletin51.Ejercicio1.Examen.model.*;
import Trimestre2.Boletin51.Ejercicio1.Examen.model.Pokemon;
import Trimestre2.Boletin51.Ejercicio1.Examen.utils.UserDataCollector;
...
public class Main {
    ...
    private static Pokemon generateRandomPokemon(){
        ...
        while (!added){
            try {
                switch (random) {
                    case 0:
                        return new PokemonAgua(generaNombrePokemonAleatorio(), (int) (Math.random() * 51 + 50), (int) (Math.random() * 11 + 5), (int) (Math.random() * 21 + 5));
                    case 1:
                        return new PokemonFuego(generaNombrePokemonAleatorio(), (int) (Math.random() * 51 + 50), (int) (Math.random() * 11 + 5), (int) (Math.random() * 21 + 5));
                    case 2:
                        return new PokemonElectrico(generaNombrePokemonAleatorio(), (int) (Math.random() * 51 + 50), (int) (Math.random() * 11 + 5), (int) (Math.random() * 21 + 5));
                    case 3:
                        return new PokemonTierra(generaNombrePokemonAleatorio(), (int) (Math.random() * 51 + 50), (int) (Math.random() * 11 + 5), (int) (Math.random() * 21 + 5));
                    case 4:
     ...
     */
    private static String generaNombrePokemonAleatorio() throws ValorNoValidoException{
